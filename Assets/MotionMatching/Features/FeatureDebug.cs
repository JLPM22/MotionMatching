...
public class FeatureDebug : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        FeatureExtractor.GetWorldOriginCharacter(pose, out Vector3 characterOrigin, out Vector3 characterForward);
        ...
        if (fv.Valid)
        {
            ...
            GizmosExtensions.DrawArrow(pose.RootMotion, pose.RootMotion + hipsVelWorld * 0.1f, 0.25f * hipsVelWorld.magnitude * 0.1f);
            // Trajectory

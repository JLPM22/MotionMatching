...
namespace MotionMatching
{
    public abstract class Feature3DExtractor : ScriptableObject
    {
        ...
        /// </summary
        public abstract float3 ExtractFeature(PoseVector pose, int poseIndex, int animationClip, Skeleton skeleton, float3 characterOrigin, float3 characterForward);
        /// <summary>

...
namespace MotionMatching
{
    public abstract class Feature4DExtractor : ScriptableObject
    {
        ...
        /// </summary
        public abstract float4 ExtractFeature(PoseVector pose, int poseIndex, PoseVector nextPose, int animationClip, Skeleton skeleton, float3 characterOrigin, float3 characterForward);
        /// <summary>
